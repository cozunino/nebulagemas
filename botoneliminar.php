...
<div class="navbarSupportedContent">
        <h4 style="text-align:center; margin-top:20px; margin-bottom:30px; justify-content:center;">Eliminar</h4>
</div>

<form action="botondelete.php?id=<?php echo $_GET['id']; ?>" method="POST">
