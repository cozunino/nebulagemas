...
<div class="collapse navbar-collapse" id="navbarSupportedContent" >
  <button type="button" class="btn btn-outline-secondary" id="administrador" data-bs-toggle="modal" data-bs-target="#exampleModaladm" data-bs-whatever="">Administrador</button>
    ...
    <div class="navbarSupportedContent">
        <h4 style="text-align:center; margin-top:20px; margin-bottom:30px; justify-content:center;">Consulta de usuarios</h4>
        
        <div id="divingresar" style="text-align:right; justify-content:flex-end; margin-top:-60px; margin-bottom:30px;">
  <a href="registro.html" >
  <button type="button" class="btn btn-outline-secondary" id="botoningresar" >Nuevo usuario</button></a>
  <a href="consultas.php" >
  <button type="button" class="btn btn-outline-secondary" id="botoningresar" >Productos</button></a>
  </div>  
    </div>
    ...
    <?php
        ...
        {?><!--apertura de ciclo-->
            ...
            <tbody>
                <tr>
                    <td>  <?php   echo $filas['email']; ?>    </td> <!--Tomar ID..Primar Key-->
                    <td>  <?php   echo $filas['nombre']; ?>    </td>
                    <td>  <?php   echo $filas['apellido']; ?>    </td>
                    <td>  <?php   echo $filas['telefono']; ?>    </td>
                    <td>  <?php   echo $filas['password']; ?>    </td>
                    <td>  <?php   echo $filas['direccion']; ?>    </td>
                    <!--<td>  <a href="botoneditarusuario.php?id=<?php echo $filas['email']; ?> "> <small> EDITAR </small> </a>  </td>
                    <td>  <a href="botoneliminar.php?id=<?php echo $filas['email']; ?> "><small>  ELIMINAR </small> </a>  </td>-->
                </tr>
            </tbody>
