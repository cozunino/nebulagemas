...
<div class="collapse navbar-collapse" id="navbarSupportedContent" >
  <button type="button" class="btn btn-outline-secondary" id="administrador" data-bs-toggle="modal" data-bs-target="#exampleModaladm" data-bs-whatever="">Administrador</button>
    ...
    <div class="navbarSupportedContent">
        <h4 style="text-align:center; margin-top:20px; margin-bottom:30px; justify-content:center;">Consulta de productos</h4>
        
        <div id="divingresar" style="text-align:right; justify-content:flex-end; margin-top:-60px; margin-bottom:30px;">
  <a href="botonregistro.html" >
  <button type="button" class="btn btn-outline-secondary" id="botoningresar" >Ingresar nuevo producto</button></a>
  <a href="consultasusuarios.php" >
  <button type="button" class="btn btn-outline-secondary" id="botoningresar" >Usuarios</button></a>
  </div>  
    </div>
    ...
    <?php
        ...
        {?><!--apertura de ciclo-->
            ...
            <tbody>
                <tr>
                    <td>  <?php   echo $filas['id']; ?>    </td> <!--Tomar ID..Primar Key-->
                    <td>  <?php   echo $filas['nombre']; ?>    </td>
                    <td>  <?php   echo $filas['precio']; ?>    </td>
                    <td>  <a href="botoneditar.php?id=<?php echo $filas['id']; ?> "> <small> EDITAR </small> </a>  </td>
                    <td>  <a href="botoneliminar.php?id=<?php echo $filas['id']; ?> "><small>  ELIMINAR </small> </a>  </td>
                </tr>
            </tbody>

        <?php } ?> <!--cierre de ciclo while-->
